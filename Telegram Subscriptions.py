...
def get_urls_from_html(html):
    ...
    # 定义要排除的域名或字符串
    excluded_domains = ("aliyundrive.com", "pan.baidu.com", "raw.githubusercontent.com", "t.me", "yam","play.google.com","app","777.hz.cz","releases","org","html","apk","appleID","apps.apple.com")
    urls = set()
