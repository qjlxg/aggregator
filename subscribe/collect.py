...
def aggregate_no_check(args: argparse.Namespace) -> None:
    ...
    # Use the generated ss.yaml as the source for subconverter
    subconverter_source_filepath = final_output_filepath # Use the saved ss.yaml
    ...
    if not records:
        ...
        # No need to remove supplier here as we used ss.yaml directly
