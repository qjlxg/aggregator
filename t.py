...
if __name__ == "__main__":
    channels = ["oneclickvpnkeys", "data_proxy","cpy_teel","wbnet","vpn_proxy66","hack_proxy","vlessfreevpn","aak_vpn",
    "abedconfigpluse",
    "ahmedhamoomi_servers",
    "aifenxiang2020",
    "alfred_config",
    "alienvpn402",
    "alismartvpn",
    ...
    "sabz_v2ray",
    "safenet4all",
    "sajad_titan_s_t_n_v2ray",
    "samiv2ray",
    "satarvpn1",
    "satellitenewspersian",
    "satoshivpn",
    "savagev2ray",
    "selinc",
    "server_housing03",
